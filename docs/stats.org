...
|                                    | defragmenter task.                     |
| ep_defragmenter_num_skipped_too_small | Number of items visited by the      |
|                                    | defragmenter task but skipped due to   |
|                                    | being too small.                       |
| ep_defragmenter_num_skipped_too_large | Number of items visited by the      |
|                                    | defragmenter task but skipped due to   |
|                                    | being too large.                       |
